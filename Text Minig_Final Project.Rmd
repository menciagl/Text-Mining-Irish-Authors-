...
First, we are going to install all the packages that we will need for this project:
...
Now, since we have the novels in .txt format (and one in .pdf), we can begin processing them by splitting the text into chapters and preparing them for analysis.
...
-   **Bowen**: her work is predominantly negative.
    ...
    We have to take into account that she is deeply focused in the effect (negative effects, above all) of different social situations, like war. Her novel takes place in London, just in the middle of the two World Wars. 
...
-   **Bowen**: her vocabulary is really variate.
    ...
    Her novel takes place in London, but it still mentions Ireland and the vocabulary that she uses seems to show a tension related to the country. We can see that she mentions several characters around the word "Ireland", which indicates that she explains that tension through her characters and their relationships.
